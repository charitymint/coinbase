...
function Coinbase (options) {
  ...
  /* POST https://coinbase.com/api/v1/buttons/:code/create_order */
  this.buttons.create_order = function (code, callback) {
    var url = self.baseUrl + 'buttons/' + code + '/create_order';
  ...
  /* GET https://coinbase.com/api/v1/buttons/:id/orders */
  this.buttons.orders = function(id, callback) {
    var url = self.baseUrl + 'buttons/' + id + '/orders';
